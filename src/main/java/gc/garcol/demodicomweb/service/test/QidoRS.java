...
/**
 * Ref: https://www.javatips.net/api/dcm4che-master/dcm4che-tool/dcm4che-tool-qidors/src/main/java/org/dcm4che3/tool/qidors/QidoRS.java
 * QIDO-RS client
 *
...
//        }
    ...
    private static String sendRequest(URL url, final QidoRS main) throws IOException {
        ...
        try {
            ParserType.JSON.readBody(main, in);
        } catch (Exception e) {
